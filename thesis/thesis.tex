...
\begin{document}
	...
	\begin{abstract}
		...
		in the development of the \acs{saas} and \acs{iaas} offerings. Interest in \acs{paas} solution
		has taken longer to ignite instead, so much so that the \acs{paas} world is still largely unexplored.
	...
	\input{chapters/measurements/main.tex}
	\input{chapters/architecture/main.tex}
