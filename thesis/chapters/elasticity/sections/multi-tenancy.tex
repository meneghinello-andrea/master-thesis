...
\begin{itemize}
	...
	\item{\keyword{secure isolation}: every tenant must have access only to its data and must do not interfere
...
\begin{itemize}
	...
	\item{\keyword{barely security}: if the software is not build and properly tested may occur that a
	...
	\item{\keyword{paradox of have to faces with higher costs}: in many cases the expenditure of re-building
