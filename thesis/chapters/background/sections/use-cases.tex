...
relevant for this problem belong to \ac{sda}. They are  \keyword{\ac{am}} and \keyword{\ac{cm}}. Bot
...
hardware and software configurations) which make the \glossaryPlr{deployment-process} more difficult.
